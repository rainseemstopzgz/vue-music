      ...
      >
        ...
        >
          <div class="lyric-wrapper">
            ...
            <div class="pur-music" v-show="pureMusicLyric">
              <p>{{pureMusicLyric}}</p>
            </div>
          </div>
        </scroll>
...
export default {
  ...
  setup() {
    ...
    const { cdCls, cdRef, imageRef } = useCd()
    const { currentLyric, currentLineNum, lyricScrollRef, lyricListRef, stopLyric, playLyric, pureMusicLyric, playingLyric } = useLyric({ songReady, currentTime })
